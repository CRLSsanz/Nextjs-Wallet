...
const HistoryRow = ({ item }: any) => {
  ...
  return (
    <>
      <div className="hidden bg-card py-5 mb-2 ">
        <div
      ...
      >
        ...
        >
          <div className="w-full flex flex-row items-start">
            {/** IMAGENES */}
            <div className=" mt-6 ml-5 w-10 h-10">
              <img
                src={`./images/category/${item.category}.png`}
                className={`w-8 h-8 p-1 rounded-full transform transition-all duration-500 ${
                  isOpen ? " bg-gray-200 " : ` xp-1 bg-gray-400 `
                } 
          `}
                alt={item.category}
              />
            ...
            <div className="p-5 w-full flex flex-col">
              ...
              {/** COMMENT */}
              <div
                className={` pr-10 transform transition-all duration-1000 ${
                  !isOpen
                    ? " text-xs text-gray-500 w-48 truncate -mt-1"
      ...
      <div
        //onClick={() => setIsOpen((prev) => !prev)}
        className={` hidden w-full Xflex flex-row bg-[#333333] text-gray-400 cursor-pointer $ {inter.className} `}
      >
        {/** IMAGENES */}
